...
File   : member6/reports/schemas/report_schema.py
...
Usage:
    ...
    # Use in tests
    from member6.reports.schemas.report_schema import get_report_schema, validate_report_dict
...
from member6.reports.json.json_report import JSONReport
...
def load_schema_file(path: Path = _SCHEMA_FILE) -> dict[str, Any]:
    ...
    if not path.exists():
        raise FileNotFoundError(
            ...
            "Run: python -m member6.reports.schemas.report_schema"
        )
...
# ── CLI: python -m member6.reports.schemas.report_schema ────────────────────
